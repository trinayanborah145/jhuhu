...
const projects = [
  { id: 1, name: "G+1 Projects", location: "Gormur", type: "Residential" },
  { id: 2, name: "G+2 Project", location: "Gormur", type: "Residential" },
  { id: 3, name: "G+2 Building", location: "Dohabara", type: "Residential" },
  { id: 4, name: "G+1 Building", location: "Golaghat", type: "Residential" },
  { id: 5, name: "G+2 Building", location: "Kenduguri", type: "Residential" },
  { id: 6, name: "G+1 Building", location: "Koronga", type: "Residential" },
  { id: 7, name: "G+2 Building", location: "Macharhat", type: "Residential" },
  { id: 8, name: "G+4 Commercial Complex", location: "Jorhat Town", type: "Commercial" },
  { id: 9, name: "Assam Type House", location: "Lichubari", type: "Residential" },
  { id: 10, name: "G+2 Building", location: "Garmur", type: "Residential" },
];
              ...
              >
                ...
                <div className="mb-8">
                  <div className="flex items-center gap-3 mb-4">
                    <span
                      className="text-[11px] uppercase tracking-[0.2em] px-4 py-2 rounded-full"
                      style={{
                  ...
                  <h2
                    className="font-display text-4xl md:text-5xl text-[#1C1C1C] mb-4"
                    style={{ fontFamily: "Cormorant Garamond, serif" }}
                  >
                    {project.name}
                  </h2>
                  <div className="w-24 h-px bg-[#B8963E]" />
                </div>
                ...
                {/* Project Details & CTA */}
                <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6 p-6 bg-white rounded-xl shadow-sm">
                  <div>
                    <p
                      className="text-[#888888] text-sm mb-2"
                      style={{ fontFamily: "DM Sans, sans-serif" }}
                    >
                      Premium construction with uncompromising quality and
                      timeless design.
                    </p>
                    <p
                      className="text-[#1C1C1C] text-xs uppercase tracking-[0.15em]"
                      style={{ fontFamily: "DM Sans, sans-serif" }}
                    >
                      Status: Ongoing
                    </p>
                  ...
                  <a
                    href={`https://wa.me/919101002790?text=${encodeURIComponent(
                      `Hi, I'm interested in ${project.name} at ${project.location}. Could you please provide more details?`
                    )}`}
                    target="_blank"
